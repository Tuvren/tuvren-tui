...
**v10.0.16** — corresponds to the latest entry in `.constitution/tasks/changelog.md`.
...
- This is a Brownfield replacement plan for the realigned PRD v3.0.0, Architecture v4.0.6, and TechSpec v9.0.17. It supersedes the prior Plugin-era active Epics U–Z instead of preserving incompatible work as active.
