...
- **Status:** superseded by ADR-T55
- **Supersession:** Detection-first remains binding, but rich permission-aware clipboard reads, typed responses, paste Events, Screen Modes, and per-capability degradation replace the write-only contract.
