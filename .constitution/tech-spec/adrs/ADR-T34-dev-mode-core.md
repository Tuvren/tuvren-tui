...
- **Status:** superseded by ADR-T56
- **Supersession:** The earlier snapshot and trace APIs become one bounded Diagnostic Graph with synchronized views, privacy, Issues, replay, and semantic testing.
