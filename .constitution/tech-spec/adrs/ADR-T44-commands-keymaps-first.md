...
- **Supersession:** Commands and Keymaps remain host orchestration, now with Effect execution, concurrency policies, scoped precedence, and UI executor transactions; no Plugin layer follows them in P0.
