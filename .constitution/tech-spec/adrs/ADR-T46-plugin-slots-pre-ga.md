...
- **Status:** superseded and rejected by PRD v3.0.0 and ADR-T50
- **Supersession:** `0.1.0` supports ordinary package composition only. RuntimeExtension and Plugin protocols require evidence and a later Evolution pass.
