...
The TechSpec data-models/terminal-capability-state.rs and ADR-T41 flag layout remains valid. `tui_get_capabilities()` returns
...
No contradiction with TechSpec data-models/terminal-capability-state.rs (ADR-T41) was found. This memo narrows multiplexer
