# Runtime Extension and Plugin system
...
- **Reason:** A Runtime Extension needs stable activation, cleanup, isolation, error, and compatibility behavior. A Plugin additionally needs discovery, installation, permissions, and lifecycle guarantees. No evidence yet shows that ordinary package composition is insufficient.
